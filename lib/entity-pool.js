...
EntityPool.prototype.remove = function(id, component) {
	if (!this.warnedRemove) {
		this.warnedRemove = true;
		console.warn("EntityPool.prototype.remove has been deprecated, use EntityPool.prototype.removeComponent instead."); // eslint-disable-line no-console
	}
	this.removeComponent(id, component);
};
